...
const HoppGRPCSaveContextSchema = z.nullable(
  z.discriminatedUnion("originLocation", [
    z
      .object({
        originLocation: z.literal("user-collection"),
...
const GRPCResponseEventSchema = z.array(
  z.union([
    z
      .object({
      ...
      z.object({
        ...
        doc: z
          .object({
            ...
            isDirty: z.boolean(),
            saveContext: z.optional(HoppGRPCSaveContextSchema),
            response: z.optional(z.nullable(GRPCResponseEventSchema)),
            optionTabPreference: z.optional(z.enum(validGrpcOperations)),
          })
          .strict(),
      })
    ),
